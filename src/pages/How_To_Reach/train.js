...
const Train = () => {
  ...
  <h2 class="h2">Sainagar Shirdi (SNSI), Sainagar Shirdi Railway Station</h2>
  <div class="train_station-details">
      ...
      <ul className="train_responsive-table">
        ...
        {list2.map((item) => (
          <li className="train_table-row" key={item.No}>
            ...
            <div className="col col-2" data-label="Train Name (Code)">{item["Train Name (Code)"]}</div>
